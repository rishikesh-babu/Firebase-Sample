...
export default function Login() {
    ...
    return (
        <div
            className={`w-full h-[100dvh] flex justify-center items-center bg-[url("backgroundImage.jpeg")] bg-cover bg-no-repeat bg-top `}
        >
            <form onSubmit={handleSubmit} className="px-5 pt-10 pb-12 w-sm sm:w-md m-5 border-sky-500 rounded-lg backdrop-blur-[20px] shadow-2xl">
